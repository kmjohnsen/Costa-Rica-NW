...
def get_route_prices():
    ...
    try:
        ...
        blackout_dates = get_cached("blackout_dates", create_blackout_date_list(cursor))
        booking_number_dict = get_cached("booking_numbers", fetch_booking_number_dict(cursor))
        ...
        return jsonify({'prices': prices, 'adjustments': adjustments})
